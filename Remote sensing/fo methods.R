...
setwd("C:/1_training/GSO Fisheries Oceanography/FO 2019/Methods of research Remote sensing lab")
wd=getwd()
...
setwd("C:/1_training/GSO Fisheries Oceanography/FO 2019/Methods of research Remote sensing lab/rasters")
wd=getwd()
...
gb_mask = readShapePoly("C:/1_training/GSO Fisheries Oceanography/FO 2019/Methods of research Remote sensing lab/shape file/gbkPoly.shp")
